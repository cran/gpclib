...
/* 2003/10/09: This function was generating warnings in R CMD check
 * because of the fprintf() statement.  Since I don't need it for
 * gpclib, I'll comment it out. */
                      ...
                      gpc_polygon *result)
{
    ...
    /* gcc complained about some non-initialization, so I set to zero.
     * I don't think it makes a difference in the end (2003/10/09) */
